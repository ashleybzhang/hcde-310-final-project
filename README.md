...
Syncup
A group scheduling web app that connects to Google Calendar to find mutual free time for a group of people, then creates the event and sends invites automatically.
